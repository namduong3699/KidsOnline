		...
		<div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-tab "  >
			<ul class="kt-menu__nav ">
				<li class="kt-menu__item  kt-menu__item--active "  aria-haspopup="true">
					<a  href="{{URL::to('teacher/attendance')}}" class="kt-menu__link ">
				...
				<li class="kt-menu__item  kt-menu__item--active "  aria-haspopup="true">
					<a  href="{{URL::to('teacher/learn-activity')}}" class="kt-menu__link ">
						<span class="kt-menu__link-text">
				...
				<li class="kt-menu__item  kt-menu__item--active "  aria-haspopup="true">
					<a  href="{{URL::to('teacher/dining')}}" class="kt-menu__link ">
						<span class="kt-menu__link-text">
				...
				<li class="kt-menu__item  kt-menu__item--active "  aria-haspopup="true">
					<a  href="{{URL::to('teacher/sleep')}}" class="kt-menu__link ">
						<span class="kt-menu__link-text">
							<i class="fa fa-bed"></i>
							&nbsp;Ngủ
						</span>
				...
				<li class="kt-menu__item  kt-menu__item--active "  aria-haspopup="true">
					<a  href="{{URL::to('teacher/hygienic')}}" class="kt-menu__link ">
						<span class="kt-menu__link-text">
				...
				<li class="kt-menu__item  kt-menu__item--active "  aria-haspopup="true">
					<a  href="{{URL::to('teacher/assessment')}}" class="kt-menu__link ">
						<span class="kt-menu__link-text">
	...
	<div class="kt-header__topbar">
		...
		<div class="kt-header__topbar-item dropdown">
			<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px" aria-expanded="true">
				...
				<!-- span class="kt-header__topbar-icon" style="width: auto; padding: 0 15px;">
					
				</span>
			-->
			<span class="kt-header__topbar-icon kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bolder" style="width: auto; padding: 0 15px;">
